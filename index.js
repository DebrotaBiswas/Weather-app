...
//check if cordiantes are already present in session storage
function getfromSessionStorage() {
    const localCoordinates = sessionStorage.getItem("user-coordinates");
    if(!localCoordinates) {
        //agar local coordiantes nahi mile
...
function renderWeatherInfo(weatherInfo) {
    ...
    //fetch values from weather Info and put it UI elements
    ...
    // errMsg.innerText = weatherInfo?.message;
...
function getLocation() {
    if(navigator.geolocation) {
        ...
        console.log('geolocation can not get');
    }
}
